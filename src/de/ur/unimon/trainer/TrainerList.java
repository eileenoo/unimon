...
public class TrainerList {
	...
	public TrainerList(){
		...
		trainer2 = new Trainer(2, "Kiffi", 48.9937000, 12.0947636, unimonList.get(1), 300, 300, false); //Vielberth
		trainer3 = new Trainer(3, "Robomon_5000", 48.9979429, 12.0973199, unimonList.get(2), 300, 400, false); //rechtsNebenBib
