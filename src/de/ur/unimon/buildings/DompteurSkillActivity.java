...
public class DompteurSkillActivity extends Activity{
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (unimon.getSkillPoints() > 0){
					...
					case "improveSkill":
						...
						break;
					case "newSkill":
						unimon.learnSpell(unimon.getNotYetLearnedSpellList().get(position));
						skillPoints.setText("Skillpoints: "+unimon.getSkillPoints());
						((BaseAdapter) spellListAdapter).notifyDataSetChanged();
						break;
					}
					...
					Toast toast = Toast.makeText(getApplicationContext(), "You dont have any Skillpoints left!",
							Toast.LENGTH_SHORT);
					toast.show();
				}
	...
	private void initListAdapter() {
		...
		if (skillType.equals("newSkill")){
			spellListAdapter = new SpellListAdapter(this, unimon.getNotYetLearnedSpellList());
		} 
		else if (skillType.equals("improveSkill")){
			spellListAdapter = new SpellListAdapter(this, unimon.getOwnedSpells());
		}	
