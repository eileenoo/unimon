...
public class TrainerList {
	...
	public TrainerList() {
		trainer1 = new Trainer(1, "BöserBube1", 48.9979054, 12.0957183,
				leckMichAmArsch(0), 70, 70);
		trainer2 = new Trainer(2, "BöserBube2", 48.9979054, 12.0957183,
				leckMichAmArsch(1), 150, 150);
		trainer3 = new Trainer(3, "BöserBube3", 48.9979054, 12.0957183,
				leckMichAmArsch(2), 250, 250);
		trainer4 = new Trainer(4, "BöserBube4", 48.9979054, 12.0957183,
				leckMichAmArsch(2), 350, 350);
		trainer5 = new Trainer(5, "BöserBube5", 48.9979054, 12.0957183,
				leckMichAmArsch(2), 150, 150);
		trainer6 = new Trainer(6, "BöserBube6", 48.9979054, 12.0957183,
				leckMichAmArsch(2), 150, 150);
		trainer7 = new Trainer(7, "BöserBube7", 48.9979054, 12.0957183,
				leckMichAmArsch(2), 150, 150);
		boss = new Trainer(2, "OberböserBube", 48.9979054, 12.0957183,
				leckMichAmArsch(3), 150, 150);
