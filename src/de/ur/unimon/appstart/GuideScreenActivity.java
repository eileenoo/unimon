...
public class GuideScreenActivity extends Activity {
	...
	WebView story_description, tipsTricks_One, tipsTricks_Two,
			tipsTricks_Three;
	Button backButton;
	...
	private void initUI() {
		...
		String htmlStoryDescription = "<html><body>" + "<p align=\"justify\">"
				+ getString(R.string.story_description_text) + "</p> "
				+ "</body></html>";
		String htmlTipsTricksOne = "<html><body>" + "<p align=\"justify\">"
				+ getString(R.string.tips_tricks_one_text) + "</p> "
				+ "</body></html>";
		String htmlTipsTricksTwo = "<html><body>" + "<p align=\"justify\">"
				+ getString(R.string.tips_tricks_two_text) + "</p> "
				+ "</body></html>";
		String htmlTipsTricksThree = "<html><body>" + "<p align=\"justify\">"
				+ getString(R.string.tips_tricks_three_text) + "</p> "
				+ "</body></html>";
	...
	private void setButtonOnClick() {
		backButton.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent backToMenu = new Intent(GuideScreenActivity.this,
